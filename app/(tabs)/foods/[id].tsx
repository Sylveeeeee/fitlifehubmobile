...
export default function FoodDetailScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#1a1b2e' }}>
      <ScrollView style={{ flex: 1, paddingHorizontal: 16, paddingTop: 40 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
          ...
          <Text style={{ color: '#ff4d4f', marginLeft: 4, marginRight: 8, fontWeight: '700' }}>
            81 Listed Nutrients
          </Text>
          <Text style={{ color: '#9ca3af' }}>Data Source: NCCDB</Text>
        </View>
